...
public class Day14Test {
    ...
    public void testPart1_3(){
        ...
        input = Arrays.asList("157 ORE => 5 NZVS",
        "165 ORE => 6 DCFZ",
    ...
    public void testPart1_4(){
        ...
        input = Arrays.asList("2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG",
    ...
    public void testPart1_5(){
        ...
        input = Arrays.asList("171 ORE => 8 CNZTR",
...
//
//        result = new Day14().part2(input);
//        assertEquals("1864121119", result);
//    }
//
//    @Test
